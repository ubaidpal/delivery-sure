 ...
 * Generated for Laravel 5.2.38 on 2016-11-01.
 *
...
namespace {
    ...
    class Api extends \App\Facades\WebServerResponse{
         ...
         * @static 
         */
        public static function already_rated($msg){
            return \App\Classes\WebServerResponse::already_rated($msg);
        }
         ...
         * @static 
         */
        public static function _get_status_change_error($withdrawal){
            return \App\Classes\WebServerResponse::_get_status_change_error($withdrawal);
        }
    ...
    class HashId extends \App\Facades\HashId{
         ...
         * @static 
         */
        public static function encode($id, $hash){
            return \App\Classes\HashId::encode($id, $hash);
        }
         ...
         * @static 
         */
        public static function deCode($id, $hash){
            return \App\Classes\HashId::deCode($id, $hash);
        }
    ...
    class Privacy extends \App\Facades\PrivacySettings{
         ...
         * @static 
         */
        public static function check($user_id, $privacy_type){
            return \App\Classes\PrivacySettings::check($user_id, $privacy_type);
        }
