    ...
    <div class="container">
        ...
        <ul class="my-jobs-list list-group">
            <li class="list-group-item">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="h3g">I need my goods delivered as soon as possible quae duo sunt, unum facit Lorem ipsum dolor sit amet.</div>
                        <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure, veritatis. Lorem ipsum dolor sit amet, consectetur adipisicing elit.</div>
                    </div><!-- /.col-xs-6 -->
                    <div class="col-xs-2">
